...
* 熟悉Hadoop M/R，Spark等主流大数据引擎，JStorm/Flink/SparkStreaming等流计算框架，
  以及HBase/MongoDB等主流NoSQL数据库，对各种数据分析处理方案的优劣和适用场景有深入的理解； 
...
* 熟练运用UNIX/Linux操作系统，熟练使用Shell/Perl/Python/Ruby中至少一种脚本语言
####  九、分布式计算引擎研发 Distributed Computing-深圳，杭州，美国
##### 岗位描述：
* 负责大规模计算引擎核心模块的设计、开发
* 提升平台资源利用率和性能； 
* 负责基础技术的积累、前沿技术、业界标准规范研究和落地
...
####  十四、Data  Transmission-Sunnyvale
##### 
